...
.. action:: A_Chase
	...
	:param flags: Modifies the behavior of the function based on the following:
		...
		- .. constant:: CHF_ALWAYSDODGE

			Always move as if the player has a sight line.
		...
		- .. constant:: CHF_NOPLAYACTIVE
			...
			Disables the random chance of playing the active sound.

		- .. constant:: CHF_NOSIGHTCHECK

			Do not look for new targets.

.. _A_Chase calling conventions:
